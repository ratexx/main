...
<section id="content">
<div class="text4">“ติดตาม ค้นหา เสนอแนะ และช่วยสร้างชุมชนเราให้น่าอยู่ได้ที่นี่ 3”</div>
	...
	<c:if  test="${!empty gallaryBlogList}">			
		  <div style="width:300px;">
		   <article class="colhome33"  >
              <div class="box1_out"   style="width:300px;">
...
<!-- content -->
		  ...
		  <!-- blog1/1 show new user -->
<c:if  test="${!empty listNewUser}">		
                ...
                <div class="box1">
				 <h2>สมาชิกปัจจุบัน</h2>
											...
											<table class="data">
												...
												<c:forEach items="${listNewUser}" var="VUserDetailImg">
														<tr>
															<td>${VUserDetailImg.firstName}	</td>
															<td>
																<c:if test="${VUserDetailImg.pathName=='TEMP'}">
																	<img width="80px" height="80px" src="/haaksq/resources/img-by-haaksq/member.png">
																</c:if>
															
																<c:if test="${VUserDetailImg.pathName!='TEMP'}">
																	<img width="80px" height="80px" src="${VUserDetailImg.pathName}${VUserDetailImg.fileName}">
																</c:if>
															
															
															</td>
															<td>	<fmt:formatDate value="${VUserDetailImg.createDate}" pattern="dd/MM/yyyy HH:mm"  /> น.</td>
														</tr>		   													
											...
											<tr>
											  ...
											  <td >${smallBlogCommu.communityName}</td>
											   ...
											   <tr>
												...
												<tr>
											      <td><strong>จำนวนที่อยู่อาศัย&nbsp; </strong></td>
											      <td>${smallBlogCommu.unitAll}</td></tr>	

												<tr>
											      <td><strong>ราคาเริ่มต้น&nbsp; </strong></td>
											      <td>${smallBlogCommu.startPrise}</td></tr>	
												  		    

												<tr>
											      <td><strong>ราคาสูงสุด&nbsp; </strong></td>
											      <td>${smallBlogCommu.endPrise}</td></tr>	

												  		    

												<tr>
											      <td><strong>ราคาที่ดิน ไม่มี มีแต่ราคสูงสุด ต่ำสุดนะเมด&nbsp; </strong></td>
											      <td></td></tr>													  		    
	...
	<c:if  test="${!empty smallBlogLifeStyle}">	
		   ...
		   <article class="colhome33">
              <div class="box1_out">
		        ...
		        <a href="../../../ajax/lobby.html/${commuId}/${lanuageId}/4" class="button"><span><span>ทั้งหมด</span></span></a></div>
			 </div>
			</article>
			</div>
	</c:if>		
