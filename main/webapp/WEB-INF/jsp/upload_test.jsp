...
<link rel="stylesheet" type="text/css" media="screen" href='<c:url value="/resources/css/upload-css/jquery-ui-1.8.16.custom.css"/>'/>
<link rel="stylesheet" type="text/css" media="screen" href='<c:url value="/resources/css/upload-css/style.css"/>'/>
<script type='text/javascript' src='<c:url value="/resources/jquery-ui-1.9.1.custom/js/jquery-1.8.2.js"/>'></script>
<script type='text/javascript' src='<c:url value="/resources/jquery-ui-1.9.1.custom/js/jquery-ui-1.9.1.custom.min.js"/>'></script>
<script type='text/javascript' src='<c:url value="/resources/js/jquery-fileupload/util.js"/>'></script>
