...
/**
 * VCommunityDownloadId generated by hbm2java
 */
@Embeddable
public class VCommunityDownloadId implements java.io.Serializable {
	...
	public VCommunityDownloadId() {
	}

	public VCommunityDownloadId(int attachId, int communityId, String fileName,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VCommunityDownloadId))
			return false;
		VCommunityDownloadId castOther = (VCommunityDownloadId) other;
