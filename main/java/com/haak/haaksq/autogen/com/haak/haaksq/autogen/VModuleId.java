...
/**
 * VModuleId generated by hbm2java
 */
@Embeddable
public class VModuleId implements java.io.Serializable {
	...
	private int moduleLanguageId;
	private int packageLanguageId;
	private int languageId;

	public VModuleId() {
	}

	public VModuleId(int packageId, int menuId, int moduleId,
			int packageMenuId, int moduleLanguageId, int packageLanguageId,
			int languageId) {
		...
		this.packageLanguageId = packageLanguageId;
		this.languageId = languageId;
	}

	public VModuleId(String packageName, String menuName, String moduleName,
			int packageId, int menuId, int moduleId, int packageMenuId,
			String moduleUrl, String moduleImageUrl, String moduleDetail,
			int moduleLanguageId, int packageLanguageId, int languageId) {
	...
	@Column(name = "module_language_id", nullable = false)
	public int getModuleLanguageId() {
		return this.moduleLanguageId;
	}

	public void setModuleLanguageId(int moduleLanguageId) {
		this.moduleLanguageId = moduleLanguageId;
	}

	@Column(name = "package_language_id", nullable = false)
	public int getPackageLanguageId() {
		return this.packageLanguageId;
	}

	public void setPackageLanguageId(int packageLanguageId) {
		this.packageLanguageId = packageLanguageId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VModuleId))
			return false;
		VModuleId castOther = (VModuleId) other;
		...
		return ((this.getPackageName() == castOther.getPackageName()) || (this
				...
				&& (this.getModuleLanguageId() == castOther
						.getModuleLanguageId())
				&& (this.getPackageLanguageId() == castOther
						.getPackageLanguageId())
		...
		result = 37
				* result
				+ (getModuleDetail() == null ? 0 : this.getModuleDetail()
						.hashCode());
		result = 37 * result + this.getModuleLanguageId();
		result = 37 * result + this.getPackageLanguageId();
