...
/**
 * VMenuModule generated by hbm2java
 */
@Entity
@Table(name = "v_menu_module", catalog = "haaksquare_db")
public class VMenuModule implements java.io.Serializable {

	private VMenuModuleId id;

	public VMenuModule() {
	}

	public VMenuModule(VMenuModuleId id) {
		this.id = id;
	}
	...
	public VMenuModuleId getId() {
		return this.id;
	}

	public void setId(VMenuModuleId id) {
		this.id = id;
	}
