...
/**
 * VMenuPermissionId generated by hbm2java
 */
@Embeddable
public class VMenuPermissionId implements java.io.Serializable {
	...
	public VMenuPermissionId() {
	}

	public VMenuPermissionId(int menuId, int roleModuleActionId) {
		this.menuId = menuId;
		this.roleModuleActionId = roleModuleActionId;
	}

	public VMenuPermissionId(int menuId, String menuName, Integer seq,
			Integer levelMenu, Integer seqSub, Integer parrentSubMenu,
			int roleModuleActionId, Integer packageId, Integer communityId,
			Integer roleId, String fgView, String fgAdd, String fgEdit,
			String fgDelete, Integer modifyBy, Date modyfyDate,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VMenuPermissionId))
			return false;
		VMenuPermissionId castOther = (VMenuPermissionId) other;
