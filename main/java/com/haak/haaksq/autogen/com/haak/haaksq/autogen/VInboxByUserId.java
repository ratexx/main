 ...
 */
@Embeddable
public class VInboxByUserId implements java.io.Serializable {
	...
	public VInboxByUserId() {
	}

	public VInboxByUserId(int id, int roleId, int worklistId, int userId) {
		this.id = id;
		this.roleId = roleId;
	...
	public VInboxByUserId(int id, String worklistTypeName, String worklistName,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VInboxByUserId))
			return false;
		VInboxByUserId castOther = (VInboxByUserId) other;
