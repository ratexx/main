...
// Generated Oct 6, 2012 11:30:44 AM by Hibernate Tools 3.4.0.CR1
...
public class VSmsemailProfiles implements java.io.Serializable {
	...
	public VSmsemailProfiles(int addressId, int communityId, int roleId,
			String userName) {
	...
	public VSmsemailProfiles(int addressId, String addressNo, String soi,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VSmsemailProfiles))
			return false;
		VSmsemailProfiles castOther = (VSmsemailProfiles) other;
