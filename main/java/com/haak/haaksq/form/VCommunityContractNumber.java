...
// Generated Oct 1, 2012 8:25:40 PM by Hibernate Tools 3.4.0.CR1
...
public class VCommunityContractNumber implements java.io.Serializable {
	...
	public VCommunityContractNumber(int contractNumberId, int communityId,
			int languageId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VCommunityContractNumber))
			return false;
		VCommunityContractNumber castOther = (VCommunityContractNumber) other;
