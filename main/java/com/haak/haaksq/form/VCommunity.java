...
// Generated Sep 10, 2012 9:27:25 PM by Hibernate Tools 3.4.0.CR1
...
public class VCommunity implements java.io.Serializable {
	...
	public VCommunity(int communityId, String fileName, String pathName,
			int fileTypeId) {
	...
	public VCommunity(int communityId, String communityName,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VCommunity))
			return false;
		VCommunity castOther = (VCommunity) other;
