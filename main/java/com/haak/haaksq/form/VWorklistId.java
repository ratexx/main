 ...
 */
public class VWorklistId implements java.io.Serializable {
	...
	public VWorklistId(int worklistId, int worklistSeq, int roleId) {
		this.worklistId = worklistId;
		this.worklistSeq = worklistSeq;
		this.roleId = roleId;
	}

	public VWorklistId(int worklistId, int worklistSeq, Integer communityId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWorklistId))
			return false;
		VWorklistId castOther = (VWorklistId) other;
